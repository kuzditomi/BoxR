...
namespace BoxR.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/game").Include("~/Scripts/BoxR.Server.js", "~/Scripts/BoxR.IClient.js", "~/Scripts/BoxR.WebClient.js", "~/Scripts/BoxR.Game.js", "~/Scripts/BoxR.Manager.js"));
