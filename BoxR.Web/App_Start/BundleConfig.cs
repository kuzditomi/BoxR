...
namespace BoxR.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/game").Include("~/js/BoxR.Manager.js","~/js/BoxR.Server.js", "~/js/BoxR.IClient.js", "~/js/BoxR.WebClient.js", "~/js/BoxR.Game.js","~/js/BoxR.Popup.js"));
