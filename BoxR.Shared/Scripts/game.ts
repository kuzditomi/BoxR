declare var gameHub;
declare function updateRound(round: bool);
declare function updateSelfScore(score: number);
declare function updateOpponentScore(score: number);
declare function win_popup();
declare function lose_popup();
...
class Game {
    ...
    public Init(n: number, selfstart: bool) {
        ...
        var squereWidthToUnit = 7; // means 5:1
